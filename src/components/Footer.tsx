    ...
    >
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-5 py-16 md:grid-cols-3 md:px-8">
        <div>
          ...
          <div className="mt-6 flex gap-3" aria-label="Follow us on social media">
            <a
              href="#"
              className="flex h-9 w-9 items-center justify-center rounded-full transition-all hover:scale-110 hover:bg-[#c84b31] hover:text-white"
              style={{
